...
It reuses the same base + stackable-overlay model as characters (see
:mod:`comicforge.library`), but instead of being placed at a height it is
scaled to *cover* a panel (or the whole canvas, for a standalone illustration).
"""
...
from .library import Character, _inner
...
def cover(scene: Character, selection, px, py, pw, ph) -> str:
